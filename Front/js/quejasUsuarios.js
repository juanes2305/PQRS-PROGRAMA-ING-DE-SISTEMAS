...
function llenarTablaQuejasPendientes() {
    ...
    fetch('http://pqrs.us-east-1.elasticbeanstalk.com/historialestados/filtro/2/2', {
        method: "GET",
        headers: {
...
function llenarTablaQuejasRespondidos() {
    ...
    fetch('http://pqrs.us-east-1.elasticbeanstalk.com/historialestados/filtro/1/2', {
        method: "GET",
        headers: {
            Authorization: `Bearer ${token}`
        }
...
function llenarTablaQuejasRechazados() {
    ...
    fetch('http://pqrs.us-east-1.elasticbeanstalk.com/historialestados/filtro/3/2', {
        method: "GET",
        headers: {
            Authorization: `Bearer ${token}`
        }
